class ProductionsController < ApplicationController
  ...
  def index
    @productions = Production.where("YEAR(production_date) = '#{params[:year]}' and MONTH(production_date) = '#{params[:month]}'")
  end
  ...
  private
    ...
    def production_params
      params.require(:production).permit(
        :production_date, :a, :b, :c, :d, :pa, :pb,
        :a_am, :a_pm, :b_am, :b_pm, :c_am, :c_pm, :d_am, :d_pm, :pb_am, :pb_pm, :pa_am, :pa_pm, 
        )
    end
end
